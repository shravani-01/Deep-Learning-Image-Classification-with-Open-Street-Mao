...
def api_download(panoid, heading, flat_dir, key, width=640, height=640,
                 fov=120, pitch=0, extension='jpg', year=pyear):
    """
    ...
    """
    print("---from api_download---")
    print(panoid, heading, year)
...
def download_flats(panoid, flat_dir, key, width=400, height=300,
                   fov=180, pitch=0, extension='jpg', year=pyear):
    for heading in [0, 90, 180, 270]:
        api_download(panoid, heading, flat_dir, key, width, height, fov, pitch, extension, year=pyear)
